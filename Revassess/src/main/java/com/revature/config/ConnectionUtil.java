...
public class ConnectionUtil {
	...
	// add your jdbc url
	public static final String URL = "jdbc:postgresql://nav-panchhi-revature.cc5gjfvhggft.us-east-2.rds.amazonaws.com:5432/postgres";
	// add your jdbc username
	public static final String USERNAME = "NavPanchhi";
	// add your jdbc password
	public static final String PASSWORD = "Navp1152";
	// name of the created stored procedure in tier 3
	public static final String TIER_3_PROCEDURE_NAME = "CREATE SEQUENCE potatoman START WITH 6 INCREMENT BY 3";
	// name of the created sequence in tier 3
	public static final String TIER_3_SEQUENCE_NAME = "potatoman";
